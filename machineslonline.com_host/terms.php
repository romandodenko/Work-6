...
<head>
  ...
  <title>Das Hilton Vienna Plaza Hotel ist ein Luxushotel im Zentrum von Wien mit Casino in Österreich. Allgemeine Geschäftsbedingungen.</title>
</head>
    ...
    <main>
        ...
        <div class="hero__container container">
          <div class="hero__left">
            <div class="hero__descr">
              ...
              <ul class="hero__list">
                <li class="hero__item">
                  <a class="hero__linl hero__linl_1 button-v1" href="index.php#contacts">
                    Kontakte
                  </a>
                </li>
                <li class="hero__item">
                  <a class="hero__linl hero__linl_2 button-v2" href="index.php#about">
                    Über das Hotel
                  </a>
                </li>
              </ul>
      ...
      <section class="terms">
        <div class="container">
          ...
          <p>Willkommen auf machineslonline.com!</p>

          <p>Diese Nutzungsbedingungen umreißen die Regeln und Vorschriften für die Nutzung von machineslonline.com
            Website, zu finden unter machineslonline.com.</p>

          <p>Durch den Zugriff auf diese Website gehen wir davon aus, dass Sie diese Bedingungen akzeptieren. Nicht weiter verwenden
            machineslonline.com, wenn Sie nicht damit einverstanden sind, alle auf dieser Seite aufgeführten Bedingungen zu akzeptieren.</p>
          ...
          <p>Wir verwenden Cookies. Mit dem Zugriff auf machineslonline.com haben Sie der Verwendung von Cookies zugestimmt
            mit der Datenschutzerklärung von machineslonline.com. </p>
          ...
          <p>Sofern nicht anders angegeben, besitzen machineslonline.com und/oder seine Lizenzgeber die geistigen Eigentumsrechte
            für alle Materialien auf machineslonline.com. Alle geistigen Eigentumsrechte sind vorbehalten. Sie dürfen zugreifen
            diese von machineslonline.com für Ihren eigenen persönlichen Gebrauch unterliegen den in diesen Bedingungen festgelegten Einschränkungen und
            Bedingungen.</p>

          <p>Sie dürfen nicht:</p>
          <ul>
            <li>Material von machineslonline.com erneut veröffentlichen</li>
            <li>Verkaufen, vermieten oder unterlizenzieren Sie Material von machineslonline.com</li>
            <li>Material von machineslonline.com reproduzieren, duplizieren oder kopieren</li>
            <li>Verbreiten Sie Inhalte von machineslonline.com weiter</li>
          </ul>

          <p>Teile dieser Website bieten Nutzern die Möglichkeit, Meinungen und Informationen zu posten und auszutauschen
            bestimmte Bereiche der Website. machineslonline.com filtert, bearbeitet, veröffentlicht oder prüft Kommentare nicht vorher
            zu ihrer Präsenz auf der Website. Kommentare spiegeln nicht die Ansichten und Meinungen von wider
            machineslonline.com, seine Vertreter und/oder verbundenen Unternehmen. Kommentare spiegeln die Ansichten und Meinungen der Person wider
            die ihre Ansichten und Meinungen posten. Soweit nach geltendem Recht zulässig, wird machineslonline.com
          ...
          <p>machineslonline.com behält sich das Recht vor, alle Kommentare zu überwachen und eventuelle Kommentare zu entfernen
          ...
          <p>Sie gewähren machineslonline.com hiermit eine nicht ausschließliche Lizenz zur Nutzung, Vervielfältigung, Bearbeitung und Autorisierung anderer
          ...
          <p>Wir werden Linkanfragen von diesen Organisationen genehmigen, wenn wir entscheiden, dass: (a) der Link uns nicht erreichen würde
            ...
            von machineslonline.com; und (d) der Link steht im Kontext allgemeiner Ressourceninformationen.</p>
          ...
          <p>Wenn Sie eine der oben in Absatz 2 aufgeführten Organisationen sind und daran interessiert sind, auf unsere zu verlinken
            Website, müssen Sie uns dies per E-Mail an machineslonline.com mitteilen. Bitte geben Sie Ihren Namen, Ihre
          ...
          <p>Die Verwendung des Logos von machineslonline.com oder anderer Grafiken ist für die Verlinkung ohne Markenzeichen nicht gestattet
