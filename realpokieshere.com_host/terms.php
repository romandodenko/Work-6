...
<head>
  ...
  <meta name="description"
    content="The Fullerton Hotel Sydney is a luxury hotel with character and entertainment all around. Evening online or offline casino in Australia can be visited in this hotel.">
  <link rel="shortcut icon" href="./img/favicon.png">
  <link rel="preload" href="./fonts/LibreCaslonText-Bold.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="stylesheet" href="./css/main-min.css">
  <script defer src="./js/main.js"></script>
  <title>Five star Fullerton hotel in Sydney Australia with the best casino. Terms and Conditions.</title>
</head>
    ...
    <main>
          ...
          <div class="hero__content">
            <div class="hero__descr">
              <h1 class="hero__title">
                <span>Hotel casino in Australia</span>
                The Fullerton Hotel Sydney
              </h1>
              <p class="hero__text">
                Experience elegance at the 5-star Fullerton Sydney Hotel, with spacious, stylish rooms and suites
              </p>
      ...
      <section class="terms">
        <div class="container">
          ...
          <p>Welcome to realpokieshere.com!</p>

          <p>These terms and conditions outline the rules and regulations for the use of realpokieshere.com's
            Website, located at realpokieshere.com.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            realpokieshere.com if you do not agree to take all of the terms and conditions stated on this page.</p>
          ...
          <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
            ...
            of the Company's stated services, in accordance with and subject to, prevailing law of ad. Any use of the
          ...
          <p>We employ the use of cookies. By accessing realpokieshere.com, you agreed to use cookies in agreement
            with the realpokieshere.com's Privacy Policy. </p>
          ...
          <p>Unless otherwise stated, realpokieshere.com and/or its licensors own the intellectual property rights
            for all material on realpokieshere.com. All intellectual property rights are reserved. You may access
            this from realpokieshere.com for your own personal use subjected to restrictions set in these terms and
            conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from realpokieshere.com</li>
            <li>Sell, rent or sub-license material from realpokieshere.com</li>
            <li>Reproduce, duplicate or copy material from realpokieshere.com</li>
            <li>Redistribute content from realpokieshere.com</li>
          </ul>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. realpokieshere.com does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views and opinions of
            realpokieshere.com,its agents and/or affiliates. Comments reflect the views and opinions of the person
            who post their views and opinions. To the extent permitted by applicable laws, realpokieshere.com shall
          ...
          <p>realpokieshere.com reserves the right to monitor all Comments and to remove any Comments which can be
          ...
          <p>You hereby grant realpokieshere.com a non-exclusive license to use, reproduce, edit and authorize others
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            of realpokieshere.com; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to realpokieshere.com. Please include your name, your
          ...
          <p>No use of realpokieshere.com's logo or other artwork will be allowed for linking absent a trademark
            license agreement.</p>
