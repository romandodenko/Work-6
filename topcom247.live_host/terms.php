...
<head>
  ...
  <title>Sheraton Melbourne Casino Hotel. Casino in Australia city Melbourne. Terms and Conditions.</title>
</head>
    ...
    <main>
      <section class="terms">
        <div class="container">
          ...
          <p>Welcome to topcom247.live!</p>

          <p>These terms and conditions outline the rules and regulations for the use of topcom247.live's
            Website, located at topcom247.live.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            topcom247.live if you do not agree to take all of the terms and conditions stated on this page.</p>
          ...
          <p>We employ the use of cookies. By accessing topcom247.live, you agreed to use cookies in agreement
            with the topcom247.live's Privacy Policy. </p>
          ...
          <p>Unless otherwise stated, topcom247.live and/or its licensors own the intellectual property rights
            for all material on topcom247.live. All intellectual property rights are reserved. You may access
            this from topcom247.live for your own personal use subjected to restrictions set in these terms and
            conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from topcom247.live</li>
            <li>Sell, rent or sub-license material from topcom247.live</li>
            <li>Reproduce, duplicate or copy material from topcom247.live</li>
            <li>Redistribute content from topcom247.live</li>
          </ul>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. topcom247.live does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views and opinions of
            topcom247.live,its agents and/or affiliates. Comments reflect the views and opinions of the person
            who post their views and opinions. To the extent permitted by applicable laws, topcom247.live shall
          ...
          <p>topcom247.live reserves the right to monitor all Comments and to remove any Comments which can be
          ...
          <p>You hereby grant topcom247.live a non-exclusive license to use, reproduce, edit and authorize others
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            of topcom247.live; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to topcom247.live. Please include your name, your
          ...
          <p>No use of topcom247.live's logo or other artwork will be allowed for linking absent a trademark
            license agreement.</p>
